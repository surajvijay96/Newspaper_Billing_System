...
if (isset($_GET['date'])) {
    ...
    $date =  date("Y-n", strtotime("first day of previous month"));//echo "$date";
...
<div class="main-form" align="center" style="margin-left: 150px;text-transform: uppercase;" >
  <table class="table table-hover table-striped" border="1" style="border-style: solid;" id="testTable" align="center" style="text-transform: uppercase;">
    <thead>
      <tr><th colspan="<?php echo "$numOfPapers"; ?>">Bill of <?php echo "$date"; ?></th></tr>
        <tr>
        <th>Paper</th>
          <?php
              $listPapers = "select paper from cost";
        ...
        <?php
          ...
          while ($rowDaysOfWeek = mysqli_fetch_assoc($resDaysOfweek)) {
            ...
            while ($rowPapers = mysqli_fetch_assoc($resPapers))
            {
              ...
              echo "<td>".$rowuc['uc']."</td><td>".$rowat['count']."</td><td>".$tc."</td>";
            }
            echo "</tr>";
          }
          ...
          while ($rowPapers = mysqli_fetch_assoc($resPapers))
          {
            ...
            echo "<td colspan='3'><b>".$$pn."</b></td>";
            $grandTotal += $$pn;
          }
          $numOfPapers = ($numOfPapers * '3');
          $numOfPapers-='2';
          echo "</tr><tr><th colspan='".$numOfPapers."'>Grand Total</th><th colspan='3'><b>$grandTotal</b></th></tr>";
        ?>
      </tbody>
      <tfoot>
