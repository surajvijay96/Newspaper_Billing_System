...
<div align="center">
<div  style="width: 70%;margin-left: 10%;position: absolute;" >
<form method="post" action="updateCost.php">
<table class="table table-striped table-hover" align="center" border="1" id="dataTable" style="margin-top: 300px;">
	<thead>
		<tr>
			<th>Select</th><th style="width: 40%">Paper</th><th>Sun</th><th>Mon</th><th>Tue</th><th>Wed</th><th>Thu</th><th>Fri</th><th>Sat</th>
        </tr>
    </thead>
    <tbody>
		<?php
                ...
                while ($rowCost = mysqli_fetch_assoc($resCost)) {
                    ...
                    echo "<td><input required type='number' min='0'  name='sunday[]' value='".$rowCost['sunday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='monday[]' value='".$rowCost['monday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='tuesday[]' value='".$rowCost['tuesday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='wednesday[]' value='".$rowCost['wednesday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='thursday[]' value='".$rowCost['thursday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='friday[]' value='".$rowCost['friday']."'></td>";
                    echo "<td><input required type='number' min='0'  name='saturday[]' value='".$rowCost['saturday']."'></td>";
                    echo "</tr>";
                }
                if(mysqli_num_rows($resCost) == '0')
                {
                    ...
                    echo "<td><input required  min='0' type='number' name='sunday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='monday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='tuesday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='wednesday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='thursday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='friday[]' value=''></td>";
                    echo "<td><input required  min='0' type='number' name='saturday[]' value=''></td>";
                    echo "</tr>";
                }
        ?>
	</tbody>
